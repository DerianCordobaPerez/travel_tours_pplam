...
exports.toString = exports.createTemplateSplashScreenAsync = exports.applyImageToSplashScreenXML = void 0;
...
function applyImageToSplashScreenXML(xml, { imageName, contentMode, }) {
    ...
    // Add ImageView
    xml.document.scenes[0].scene[0].objects[0].viewController[0].view[0].subviews[0].imageView.push(imageView);
    // Add Constraints
    xml.document.scenes[0].scene[0].objects[0].viewController[0].view[0].constraints[0].constraint.push(
    // <constraint firstItem="EXPO-SplashScreen" firstAttribute="top" secondItem="EXPO-ContainerView" secondAttribute="top" id="2VS-Uz-0LU"/>
    createConstraint([imageId, 'top'], [containerId, 'top']), createConstraint([imageId, 'leading'], [containerId, 'leading']), createConstraint([imageId, 'trailing'], [containerId, 'trailing']), createConstraint([imageId, 'bottom'], [containerId, 'bottom']));
    // Add resource
