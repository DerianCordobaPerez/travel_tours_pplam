...
exports.createAdaptiveIconXmlString = exports.configureAdaptiveIconAsync = exports.setIconAsync = exports.getAdaptiveIcon = exports.getIcon = exports.withAndroidIcons = exports.ANDROID_RES_PATH = exports.dpiValues = void 0;
    ...
    return config_plugins_1.withDangerousMod(config, [
        ...
        async (config) => {
            ...
            await setIconAsync(config.modRequest.projectRoot, {
                ...
                backgroundColor,
                backgroundImage,
                isAdaptive: !!((_a = config.android) === null || _a === void 0 ? void 0 : _a.adaptiveIcon),
            });
            return config;
        },
    ]);
 ...
 */
async function setIconAsync(projectRoot, { icon, backgroundColor, backgroundImage, isAdaptive, }) {
    if (!icon) {
        return null;
    }
...
async function createAdaptiveIconXmlFiles(projectRoot, icLauncherXmlString, add) {
    ...
    if (add) {
        await fs_extra_1.default.writeFile(launcherPath, icLauncherXmlString);
        await fs_extra_1.default.writeFile(launcherRoundPath, icLauncherXmlString);
    }
    else {
